#!/bin/bash
#SBATCH -o ./Project4-Bonus-Results.txt
#SBATCH -p Project
#SBATCH -J Project4
#SBATCH --nodes=1
...
echo "CNN OpenACC"
srun -n 1 --gpus 1 ${CURRENT_DIR}/build/cnn_openacc $TRAIN_X $TRAIN_Y $TEST_X $TEST_Y
echo ""

echo "CNN Sequential"
srun -n 1 --gpus 1 ${CURRENT_DIR}/build/cnn $TRAIN_X $TRAIN_Y $TEST_X $TEST_Y
echo ""
