async function drawMap() {
  ...
  const colorFiller = function (d) {
    const metricValue = metricDataByCountry[countryIdAccessor(d)];

    return metricValue ? colorScale(metricValue) : "#cfd8de";
  };
  ...
  function onMouseEnter(e, datum) {
    ...
    tooltip
      .style("transform", `translate(${x - 85}px, ${y - 65}px)`)
      .style("opacity", 1);
  }
